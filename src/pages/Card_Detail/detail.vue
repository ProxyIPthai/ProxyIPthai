<template>
  <div class="">
    ...
    <div v-else-if="post" class="max-w-screen-xl flex justify-center ite mt-40">
      <div class="prose" v-html="post.content"></div>
    </div>
    <div v-else>Post not found or an error occurred.</div>
  </div>
</template>
...
// Computed property to get sanitized content
</script>
